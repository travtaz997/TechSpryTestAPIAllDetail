...
const routes: Route[] = [
  ...
  { path: '/admin/pricing', component: () => <AdminGuard><AdminPricing /></AdminGuard>, exact: true },
  { path: '/admin/navigation', component: () => <AdminGuard><AdminNavigation /></AdminGuard>, exact: true },
